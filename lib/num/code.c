...
void num_clean(num_p num) // TODO test
{
    memset(num->chunk, 0, num->size * sizeof(uint64_t));
    num->count = 0;
}

num_t num_cut(num_p num, uint64_t pos)  // TODO TEST
{
    return (num_t)
    {
        .size = num->size - pos,
