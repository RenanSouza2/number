...
void test_num_ssm_shl(bool show)
{
    ...
    {                                                   \
        ...
        {                                               \
            ...
            num_ssm_shl(num_aux, num, POS, N, BITS);    \
            assert(num_immed(num, ARG_OPEN RES));       \
            num_free(num_aux);                          \
        }                                               \
        TEST_CASE_CLOSE                                 \
